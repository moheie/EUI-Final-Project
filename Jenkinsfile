    ...
    stages {
        ...
        stage('Dockerize') {
            steps {
                ...
                sh "docker build -t ${DOCKER_HUB_REPO}-build-${BUILD_NUMBER}:latest ."
            }
        }
        ...
        stage('Push to Docker Hub') {
            steps {
                ...
                sh '''
                    ...
                    docker push ${DOCKER_HUB_REPO}-build-${BUILD_NUMBER}:latest
                    docker logout
                '''
            }
        }
        ...
        stage('Deploy with Ansible') {
            steps {
                ...
                sh '''
                    ...
                    --extra-vars "\
                        docker_image=${DOCKER_HUB_REPO}-build-${BUILD_NUMBER}:latest \
